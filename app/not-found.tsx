  ...
  return (
    <section className="relative flex min-h-screen items-center overflow-hidden bg-linear-to-b from-brand-50 via-white to-secondary-50 py-32">
      ...
      <Container className="relative text-center">
        <p className="font-heading text-4xl font-extrabold text-brand-100 sm:text-5xl">404</p>
        <h1 className="-mt-6 text-[26px] font-extrabold text-ink-900 sm:text-[34px]">This page wandered off the map</h1>
