...
export const metadata: Metadata = {
  title: "Upcoming Events & Bootcamps | Tech4Bharat",
  description:
    "Explore upcoming Tech4Bharat bootcamps, workshops, challenges, hackathons, and demo days across India.",
  openGraph: {
    title: "Upcoming Events | Tech4Bharat",
    description: "Upcoming startup bootcamps, masterclasses, and founder challenges across India.",
    type: "website",
    locale: "en_IN",
  },
};
...
export default function UpcomingEventsPage() {
  ...
  const standardEvents = upcomingEvents.filter((e) => e.id !== featuredBootcamp?.id);

  return (
    <>
      <PageHero
        title="Upcoming Events"
        description="Join our upcoming bootcamps, masterclasses, innovation challenges, and investor connect sessions across India."
        icon={CalendarCheck}
      />
      ...
      {featuredBootcamp && (
        <section className="bg-white pt-8 pb-4 sm:pt-12 sm:pb-6">
          <Container>
            <AnimatedSection>
              <div className="relative overflow-hidden rounded-3xl border-2 border-brand-200 bg-gradient-to-r from-[#0B2A4A] via-[#103E6B] to-[#155E9A] p-6 sm:p-10 text-white shadow-xl">
                <div className="relative z-10 grid gap-6 lg:grid-cols-[1.5fr_1fr] lg:items-center">
                  <div>
                    ...
                    <p className="mt-2 text-xs sm:text-sm leading-relaxed text-white/80 max-w-xl">
                    ...
                    <div className="mt-6 flex flex-wrap gap-3">
                      ...
                      >
                        Explore Bootcamp Page <ArrowRight size={15} />
                      </Button>
                      <Button
                        href="/contact"
                        variant="outline"
          ...
          <AnimatedSection className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-8">
            <div>
              <span className="text-xs font-bold uppercase tracking-wider text-brand-700">
                Scheduled Cohorts &amp; Workshops
              </span>
              <h2 className="mt-1 text-xl sm:text-2xl font-bold text-[#0B2A4A]">
                All Upcoming Sessions ({standardEvents.length})
              </h2>
            </div>
