...
export default function MentorCard({
  ...
  return (
    <Card className="flex h-full flex-col items-center p-8 text-center">
      ...
      <p className="text-sm font-semibold text-brand-600">{designation}</p>
      ...
      {linkedinUrl && (
        <a
          ...
          className="mt-5 flex h-9 w-9 items-center justify-center rounded-full bg-brand-50 text-brand-700 transition-colors hover:bg-brand-500 hover:text-white"
        >
