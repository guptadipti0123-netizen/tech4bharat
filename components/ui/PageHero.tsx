    ...
    <section className="relative bg-gradient-to-b from-[#EBF3FA] via-[#F8FAFC] to-white pb-8 pt-20 sm:pb-12 sm:pt-24 border-b border-slate-200/50">
      <Container className="relative">
        <AnimatedSection className="mx-auto max-w-3xl text-center">
          <h1
            className={cn(
              "text-[26px] font-extrabold leading-tight tracking-tight text-ink-900 sm:text-[34px] lg:text-[40px]",
              titleClassName
            )}
          >
            {title}
          ...
          <p
            className={cn(
              "mx-auto mt-3 max-w-2xl text-[14px] sm:text-[16px] leading-relaxed text-slate-600",
              descriptionClassName
            )}
          >
            {description}
