...
export default function PartnerCategoryGrid() {
  return (
    <section className="relative overflow-hidden bg-sand-50 pb-8 pt-5 sm:pb-8 sm:pt-9">
          ...
          {partnerCategories.map((group, groupIndex) => (
            ...
            >
              <div className="flex flex-wrap items-baseline gap-x-3 gap-y-1">
                <h3 className="text-base font-bold text-ink-900 sm:text-lg">{group.category}</h3>
                <span className="text-sm text-slate-500">{group.tagline}</span>
                <span className="ml-auto text-[11px] font-semibold uppercase tracking-wide text-slate-400 sm:text-xs">
