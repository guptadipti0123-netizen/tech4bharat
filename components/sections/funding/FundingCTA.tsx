...
/** Closing CTA â€” one bold, solid-green premium banner instead of another white card
        ...
        <AnimatedSection>
          <div className="relative overflow-hidden rounded-[28px] bg-linear-to-br from-brand-700 to-brand-900 px-6 py-12 text-center shadow-xl sm:px-12 sm:py-16">
            <div
              ...
              style={{ background: "radial-gradient(ellipse 60% 60% at 80% 0%, rgba(47,128,237,0.25), transparent 60%)" }}
              aria-hidden="true"
            />
            <h2 className="relative text-[22px] font-extrabold text-white sm:text-[26px] lg:text-[30px]">
              Ready to Raise Funding?
            </h2>
            <p className="relative mx-auto mt-3 max-w-lg text-[15px] leading-relaxed text-white/80">
