              ...
              <AnimatedSection key={program.title} delay={0.05 + i * 0.04} className="h-full">
                ...
                >
                  <div className="relative h-24 sm:h-36 lg:h-44 w-full shrink-0 overflow-hidden bg-slate-100">
                    ...
                    />
                    <span className="absolute top-2 left-2 inline-flex items-center rounded-full bg-white/95 px-2 py-0.5 text-[10px] sm:text-[11px] font-bold uppercase text-[#1e3a8a] shadow-xs">
                      {program.badge}
                    </span>
                  </div>
                  <div className="flex flex-1 flex-col p-2.5 sm:p-4">
                    <h3 className="text-[14px] sm:text-[16px] font-bold text-[#020024] leading-snug">
                      {program.title}
                    </h3>
                    <p className="mt-1 line-clamp-2 text-[12px] sm:text-[13px] leading-snug text-gray-600">
                      {program.description}
                    </p>
                    <div className="mt-auto flex items-center gap-1 pt-2.5 text-xs sm:text-[13px] font-semibold text-[#1e3a8a] group-hover:text-[#4f6ff2]">
