...
export default function AboutHero() {
  return (
    <section className="relative aspect-4/3 min-h-140 w-full overflow-hidden rounded-b-[48px] bg-[#0B2A4A] sm:min-h-160 lg:h-screen lg:min-h-screen">
      <Image
      ...
      <div className="relative flex h-full items-end pb-10 pt-20 sm:pb-12 lg:h-screen lg:pb-16">
        <Container>
