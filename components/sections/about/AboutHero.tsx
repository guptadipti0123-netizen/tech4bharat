...
export default function AboutHero() {
  return (
    <section className="relative aspect-4/3 min-h-140 w-full overflow-hidden rounded-b-[48px] bg-[#0B2A4A] sm:aspect-[21/9] sm:min-h-0 sm:max-h-[420px] lg:max-h-[440px]">
      <Image
      ...
      <div className="relative flex h-full items-end pb-10 pt-20 sm:pb-10 lg:pb-12">
        <Container>
